...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_CHLOROPHYLL },
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_SOLAR_POWER, ABILITY_NONE, ABILITY_SOLAR_POWER },
...
#define CHARIZARD_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 109 : 85)
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .abilities = { ABILITY_RAIN_DISH, ABILITY_NONE, ABILITY_RAIN_DISH },
